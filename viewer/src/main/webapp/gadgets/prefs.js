...
(function() {
  ...
  var instance = null;
  var prefs = {};
  // variable initialized with URL params that should be available for the Gadget
  var urlParams = null;
 ...
 */
  function parseUrl() {
    var params = gadgets.util.getUrlParameters(urlParams);
    for (var i in params) {
 ...
 */
  ...
  /**
   * [AD] Initializes URL params used for User Prefs.
   */
    gadgets.Prefs.setUrlParams_ = function(urlparams) {
      urlParams = urlparams;
